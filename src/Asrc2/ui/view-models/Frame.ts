// import { Frame as FrameBase } from "w3ts/index";
...
//     public SetColor(a: number, r: number, g: number, b: number) {
//         // let rgb = ((r & 0x0ff) << 16) | ((g & 0x0ff) << 8) | (b & 0x0ff);
//         BlzFrameSetVertexColor(this._frame, BlzConvertColor(a, r, g, b));
//         return this;
//     }
...
//         BlzFrameClearAllPoints(this._frame)
//         BlzFrameSetAbsPoint(this._frame, FramePoint.C, 3, 0)
//     }
// }