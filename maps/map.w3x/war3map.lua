...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    gg_unit_Hblm_0003 = BlzCreateUnitWithSkin(p, FourCC("Hblm"), 19.2, -924.3, 3.208, FourCC("Hblm"))
    u = BlzCreateUnitWithSkin(p, FourCC("nDUM"), -142.0, -1323.6, 67.096, FourCC("nDUM"))
